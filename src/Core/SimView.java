 ...
 *
 *          This state displays the results of the simulation and asks the user
 *          if they wish to view their portfolio or simulate again off the last
 *          simulation result as the init value for the new simulation.
 */
public class SimView extends State {
	...
	void execute() {
		...
		if (in == 1)
			System.out.println("Your portfolio's value is reset back to " + getContext().getPort().getPortfolioValue());
	}
